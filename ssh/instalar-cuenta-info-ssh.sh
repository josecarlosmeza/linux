...
echo "Compatibilidad PAM: el limitador de sesiones (p. ej. check_ssh_limits en la fase «account») no"
echo "  choca con este hook: aquí se usa «session optional» solo para mostrar texto, no para denegar."
